...
const styles = StyleSheet.create({
  container: { flex: 1 }, content: { padding: 20, paddingBottom: 40, width: '100%', maxWidth: 960, alignSelf: 'center' }, back: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 24 }, backText: { fontSize: 16 }, title: { fontSize: 28, fontWeight: '700', marginBottom: 18 }, summary: { borderWidth: 1, padding: 18, borderRadius: 8 }, category: { fontSize: 18, fontWeight: '600' }, total: { fontSize: 30, fontWeight: '700', marginVertical: 10 }, meta: { fontSize: 13 }, description: { marginTop: 12, fontSize: 15 }, receipt: { width: '100%', height: 260, marginTop: 18 }, paymentSection: { borderTopWidth: 1, marginTop: 22, paddingTop: 18 }, sectionTitle: { fontSize: 19, fontWeight: '700', marginBottom: 10 }, paymentLine: { fontSize: 15, marginBottom: 6 }, input: { borderWidth: 1, borderRadius: 6, padding: 12, marginTop: 14, fontSize: 16 }, button: { padding: 14, borderRadius: 6, alignItems: 'center', marginTop: 12 }, buttonText: { fontSize: 16, fontWeight: '700' },
});
